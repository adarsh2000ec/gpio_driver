...
#define SRAM2_BASEADDR  0x20001C00U    		/* Base address of SRAM2 ==>(SIZEOF(SRAM1_BASEADDR)*/
#define ROM_BASEADDR	0x1FFF0000U			/* Base address of ROM*/

/*
 * Base address of AHPx and  APBx Bus peripheral base address
 */
#define PERIPHERAL_BASEADDR 0x40000000U 		/* Peripheral base address starts from 0x40000000 acc to memory map*/
#define APB1PERIPH_BASEADDR PERIPHERAL_BASEADDR /*Peripherals address hanging on APB1 bus*/
#define APB2PERIPH_BASEADDR 0x40010000U			/*Peripherals address hanging on APB2 bus*/
#define AHB1PERIPH_BASEADDR 0x40020000U			/*Peripherals address hanging on AHB1 bus*/
#define AHB2PERIPH_BASEADDR 0x50000000U			/*Peripherals address hanging on AHB2 bus*/
...
/*
 * Structure for GPIO , refer trm for structure members
 *
 */
typedef struct
{
...
/*
 * Perpheral defintitions (assign memory to structures as per memmap
 */

#define GPIOA ((GPIO_RegDef_t*)GPIOA_BASEADDR)   // ==> GPIO_RegDef_t *ptr=(GPIO_RegDef_t*)(0x400020000) ==>GPIO_RegDef_t *ptr=GPIOA;
...
#define GPIOA_PCLK_DI()    	(RCC->AHB1ENR &= ~(1 << 0)) // ~ will make remaining bits as 1 so remaining bits are unaffected
